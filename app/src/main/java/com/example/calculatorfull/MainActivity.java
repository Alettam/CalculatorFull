...
public class MainActivity extends AppCompatActivity {
    ...
    Switch engineerSwitch;
    LinearLayout linearLayout, engineerLayout;
    ...
    private void initview() {
        ...
        engineerLayout = findViewById(R.id.engineerLayout);
        engineerSwitch = findViewById(R.id.engineerSwitch);
        engineerSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
